...
const SERVER_ICON = 'https://media.discordapp.net/attachments/1508866023292535046/1514409339077660702/ChatGPT_Image_May_26_2026_05_26_11_AM.png?ex=6a2b431a&is=6a29f19a&hm=7af711bf3934d41d4ce4c1dfb5c4508278c79f646e867b3884115ec94425bca6&=&format=webp&quality=lossless&width=852&height=852';
  ...
  while ((match = mentionRegex.exec(content)) !== null) {
    ...
    parts.push(
      <span className="mention" key={`${id}-${match.index}`}>
        @README.md (<built-in function id>)
      </span>
    );
          ...
          {messages.map((message) => (
            <article className="message" key={message.id}>
              ...
              <div className="messageBody">
                ...
                {message.content && <div className="content">{renderContentWithMentions(message.content, userMap)}</div>}
